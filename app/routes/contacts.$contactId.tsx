...
// Define the loader to fetch contact details with a type check
...
export default function Contact() {
  // Use `useLoaderData` to access loader data with defined type
...
// Favorite component to handle favorite functionality
const Favorite: FunctionComponent<{ contact: Pick<ContactRecord, "favorite" | "id"> }> = ({ contact }) => {
  ...
  return (
    ...
    <Form method="post" action={`favorite/${contact.id}`}> </Form>
      <button
